# Google Security Operations ハンズオン
...
[Gemini in SecOps 機能コース](./gemini/01-access) :  AI を活用したセキュリティ運用の方法を確認します。(約30分)

[脅威ハンティング コース](./threathunt/01-access) :  脅威ハンティングを体験します。(約40分)
